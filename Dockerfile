...
# PostHog (optional) — baked into the static bundle at build time
ARG VITE_POSTHOG_API_KEY=
ARG VITE_POSTHOG_HOST=https://us.i.posthog.com
ARG VITE_POSTHOG_DISABLE_SESSION_RECORDING=true
ARG VITE_POSTHOG_AUTOCAPTURE=false
ENV VITE_POSTHOG_API_KEY=$VITE_POSTHOG_API_KEY \
    VITE_POSTHOG_HOST=$VITE_POSTHOG_HOST \
    VITE_POSTHOG_DISABLE_SESSION_RECORDING=$VITE_POSTHOG_DISABLE_SESSION_RECORDING \
    VITE_POSTHOG_AUTOCAPTURE=$VITE_POSTHOG_AUTOCAPTURE
